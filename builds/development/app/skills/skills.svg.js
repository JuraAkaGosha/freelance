...
(function() {
  var count, fShape, foShape, ftAttr, icon1, icon11, icon110, icon111, icon112, icon113, icon114, icon115, icon12, icon13, icon14, icon15, icon16, icon17, icon18, icon19, icon2, icon21, icon22, icon3, icon4, icon41, icon410, icon411, icon412, icon413, icon414, icon42, icon43, icon44, icon45, icon46, icon47, icon48, icon49, sShape, sfoAttr, skillsPaper, tContainer, tContainer1, tContainer2, tContainer3, tContainer4, tShape;
    ...
    if ($(this).scrollTop() > $("#skills").offset().top - 200) {
      if (count === 0) {
        ...
        tShape.animate({
          ...
          return icon3.animate({
            fill: "#fff"
          }, 100, mina.easeout);
        });
        return foShape.animate({
          strokeDashoffset: 0
        }, 1000, mina.easeinout, function() {
          foShape.animate({
            strokeWidth: 0,
