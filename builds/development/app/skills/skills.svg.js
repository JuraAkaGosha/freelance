...
(function() {
  var count, fShape, icon1, icon11, icon110, icon111, icon112, icon113, icon114, icon115, icon12, icon13, icon14, icon15, icon16, icon17, icon18, icon19, icon2, icon21, icon22, sShape, skillsPaper, tContainer, tContainer1, tContainer2, tContainer3, tContainer4;
